"use client";
// filepath: src/components/catalogo/SmartReorder.tsx
...
export default function SmartReorder({
  ...
  return (
    <div style={{ marginTop: "16px", marginBottom: "20px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px", padding: "0 16px" }}>
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* Acción rápida animada */}
                <div style={{ height: "32px", display: "flex", alignItems: "flex-end", justifyContent: "flex-end" }}>
                  <AnimatePresence mode="wait">
                    {isInCart ? (
                      <motion.div
                        key="qty-ctrl-small"
                        initial={{ opacity: 0, scale: 0.8, width: 32 }}
                        animate={{ opacity: 1, scale: 1, width: 72 }}
                        exit={{ opacity: 0, scale: 0.8, width: 32 }}
                      ...
                      >
                        ...
                        <span style={{ fontSize: "11px", fontWeight: 800, width: "20px", textAlign: "center" }}>{qty}</span>
                        <button
                          onClick={() => {
                            haptic.add();
                            onQtyChange(item.codigo, qty + 1);
