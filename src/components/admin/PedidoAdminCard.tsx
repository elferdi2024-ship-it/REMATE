      ...
      <div className="relative z-10 p-4 sm:p-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-1 min-w-0 flex-1">
            <h3 className="font-display text-lg sm:text-xl sm:text-2xl font-bold tracking-tight text-[var(--admin-text-hi)] truncate flex items-center gap-2" title={pedido.clienteNombre}>
              {status === "no_leido" && (
          ...
          <div className="shrink-0 self-end sm:self-center text-right">
            <p className="font-display text-2xl sm:text-4xl font-bold tracking-tighter text-[var(--admin-text-hi)]">
              {formatCurrency(pedido.total)}
            </p>
          </div>
        </div>

        {/* Action Bar (100% Responsivo y Premium) */}
        <div className="mt-6 flex flex-wrap items-center gap-2">
          {pedido.clienteTelefono ? (
            <a 
              ...
              className="flex-1 min-w-[140px] h-10 flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-[#25D366] to-[#1DA851] px-3 text-[11px] font-black tracking-widest text-white shadow-sm transition-all hover:brightness-105 active:scale-95 whitespace-nowrap"
            >
            ...
            <div className="flex-1 min-w-[140px] h-10 flex items-center justify-center rounded-xl bg-[var(--admin-bg)] text-[var(--admin-text-lo)] border border-[var(--admin-border)] px-3 text-[11px] font-black tracking-widest whitespace-nowrap">
              SIN TELÉFONO
            </div>
          )}
          ...
          <button
            ...
            className={`h-10 flex items-center justify-center gap-1.5 px-3.5 rounded-xl border text-[11px] font-black tracking-widest transition-all active:scale-95 whitespace-nowrap ${
              isViewingReceipt 
          ...
          <button
            ...
            className="h-10 flex items-center justify-center gap-1.5 px-3.5 rounded-xl border border-[var(--admin-border)] bg-[var(--admin-bg)] text-[var(--admin-text-mid)] hover:bg-[var(--admin-input-bg)] hover:text-[var(--admin-text-hi)] text-[11px] font-black tracking-widest transition-all active:scale-95 whitespace-nowrap"
          >
          ...
          <button
            ...
            disabled={isUpdating}
            className="flex-1 min-w-[120px] h-10 flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-[var(--admin-accent)] to-blue-500 text-[var(--admin-sidebar-bg)] font-black tracking-widest px-3 text-[11px] transition-all hover:brightness-105 active:scale-95 disabled:opacity-50 whitespace-nowrap"
          >
            <span>📋 FACTURAR</span>
          </button>
          ...
          <button
            ...
            disabled={isUpdating}
            className="w-10 h-10 shrink-0 flex items-center justify-center rounded-xl border border-red-500/20 bg-red-500/10 text-red-600 dark:text-red-400 hover:bg-red-500/20 transition-all font-bold active:scale-95"
